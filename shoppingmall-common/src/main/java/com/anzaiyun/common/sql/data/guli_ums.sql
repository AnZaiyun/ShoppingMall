/*
 ...
 Source Schema         : guli_ums

 Target Server Type    : MySQL
 Target Server Version : 80015
 File Encoding         : 65001

 Date: 24/08/2020 23:19:36
*/
...
CREATE TABLE `ums_growth_history`  (
  ...
  `count` int(11) NULL DEFAULT NULL COMMENT '变动数量',
  `remark` varchar(0) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `source_type` tinyint(4) NULL DEFAULT NULL COMMENT '来源',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '成长积分记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_integration_history`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` bigint(20) NULL DEFAULT NULL COMMENT 'member_id',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `count` int(11) NULL DEFAULT NULL COMMENT '变动数量',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `source_type` tinyint(4) NULL DEFAULT NULL COMMENT '来源',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '购物积分记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_user`  (
  ...
  `source_type` tinyint(4) NULL DEFAULT NULL COMMENT '来源',
  `integration` int(11) NULL DEFAULT NULL COMMENT '购物积分',
  `growth` int(11) NULL DEFAULT NULL COMMENT '赠送积分',
...
CREATE TABLE `ums_user_address`  (
  ...
  `post_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '右边',
  ...
  `default_status` tinyint(1) NULL DEFAULT NULL COMMENT '是否默认地址',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ums_user_collect_shop`  (
  ...
  `shop_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '店铺名',
  `shop_logo` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '店铺logo',
  `createTime` datetime(0) NULL DEFAULT NULL COMMENT '关注时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '关注店铺表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_user_collect_sku`  (
  ...
  `sku_title` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'sku标题',
  `sku_image` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'sku默认图片',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '关注商品表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_user_collect_subject`  (
  ...
  `subject_id` bigint(20) NULL DEFAULT NULL COMMENT '活动id',
  `subject_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '活动名称',
  `subject_image` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '活动默认图片',
  `subject_url` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '活动链接',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '关注时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '关注活动表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_user_level`  (
  ...
  `default_status` tinyint(4) NULL DEFAULT NULL COMMENT '默认等级',
...
CREATE TABLE `ums_user_statistics`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '统计信息表' ROW_FORMAT = Dynamic;
